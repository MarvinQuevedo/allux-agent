...
const SLASH_COMMANDS: &[(&str, &str)] = &[
    ...
    ("/think", "Toggle model reasoning (off = faster)"),
    ("/think on", "Enable model reasoning"),
    ("/think off", "Disable model reasoning (faster)"),
    ("/keepalive", "Keep model warm between turns (e.g. 30m)"),
    ...
    ("/stop", "Stop a background process (/stop <pid|all>)"),
